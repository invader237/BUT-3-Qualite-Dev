...
public class CompteController implements ComptesApi {
    ...
    public List<CompteDto> getAllComptes() {
        log.info("Récupération de tous les comptes par un gestionnaire");

        List<Compte> comptes = compteCatalog.obtenirToutLesComptes();

        log.info("Récupération de tous les comptes réussie, nombre de comptes récupérés: {}", comptes.size());
    ...
    public List<CompteDto> getComptesClient(String id) {
        ...
        log.info("Récupération de tous les comptes pour le client {}", utilisateur.getUserId());
        ...
        log.info("Récupération de tous les comptes pour le client {} réussie, nombre de comptes récupérés: {}", utilisateur.getUserId(), comptes.size());
